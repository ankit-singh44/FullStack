...
export default function Ue(){
    ...
    // }) // it will run in mounting as well as in updating phase 
    ...
    useEffect(()=>{
        console.log("running for text form and age updation")
    },[text,age])  //it will run in mounting phase as well as updation of text or age updation
